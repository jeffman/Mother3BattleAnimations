...
namespace RopeSnake.Gba
{
    public class Lz77Compressor : ICompressor
    {
        ...
        private static readonly ThreadLocal<ByteArraySource> _compressBuffers;

        public bool CompressToVram { get; }

        static Lz77Compressor()
        {
            _compressBuffers = new ThreadLocal<ByteArraySource>(() => new ByteArraySource(_compressBufferSize));
        }
